...
MIC_DEVICE_INDEX = int(_mic_idx) if _mic_idx.isdigit() else None
_spkr_idx = os.getenv("SPEAKER_DEVICE_INDEX", "")
SPEAKER_DEVICE_INDEX = int(_spkr_idx) if _spkr_idx.isdigit() else None
